...
using UnitTestTutorial.Test.MockService;
...
{
    [TestClass]
    public class CalculatorConrollerFixtureUsingMocks
    {
        [TestInitialize]
        public void OonTestInitialize()
        {
            _SystemUnderTest = null;
            _CalculateServiceInstance = null;
        }
        ...
        private MockCalculatorService _CalculateServiceInstance;
        ...
        public MockCalculatorService CalculatorServiceInstance
        {
            get
            {
                ...
                {
                    _CalculateServiceInstance = new MockCalculatorService();
                    _CalculateServiceInstance.ReturnValue = DEFAULT_RETURN_VALUE;
                }
